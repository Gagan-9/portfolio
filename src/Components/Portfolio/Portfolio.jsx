        ...
        <div id="portfolio" className={`${portfolioCSS.PortfolioWrapper} section`}>
            ...
            <div className={portfolioCSS.portfolioCards}>
                ...
                <div className={portfolioCSS.card}>
                    ...
                    <div className={portfolioCSS.cardInfo}>
                        <span className={portfolioCSS.projectName}>Voting Application</span>
                        <div className={portfolioCSS.links}>
                            <a href="https://github.com/Gagan-9/Voting.git" target="_blank" rel="noopener noreferrer">GitHub</a>
                            <a href="https://live-demo-link.com/todolist" target="_blank" rel="noopener noreferrer">Live Demo</a>
                        </div>
                    </div>
                </div>
